...
===============================================================================
 ...
 Version     : v1.0
 date		 : 05/08/2016
 Description : Distintas funcionalidades del menu del display
===============================================================================
*/
#include "gpio.h"
#include "Menu.h"
...
char				menuactual,toca,toca1,modo_func,
...
uint32_t Func_MuestraTeclado(int opcion)
{
	...
	case 4:
			WG12864A_posXY(83, 1);
			WG12864A_printf("Anio  ", Arial8x6, NEGRO);
			WG12864A_posXY(118, 2);
			WG12864A_printf("*", Arial8x6, NEGRO);
			break;
	case 5:
					...
					while((!((0xD0 < adc_valX) &&(adc_valX < 0xEA) && (0x2A < adc_valY) && (adc_valY < 0x5A))) && flagesp!=1) // Mientras no se presione back
					{
						...
						case 4:
							...
							while((!((0xD0 < adc_valX) &&(adc_valX < 0xEA) && (0x2A < adc_valY) && (adc_valY < 0x5A))) && salir==0) // Mientras no se presione back
							{
								...
								WG12864A_posXY(1, 3);
								WG12864A_printf("Fecha  Mes  Anio", Arial8x6, NEGRO);	// Muestra que los datos ingresados sean correctos
