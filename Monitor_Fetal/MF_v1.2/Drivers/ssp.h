...
#define SSP_SLAVE		0 		/* 1 is SLAVE mode, 0 is master mode SSP_1*/
#define SSP_SLAVE_0		0//1		/* 1 is SLAVE mode, 0 is master mode SSP_0 */
...
#define DSS_4_BIT_TRANSFER	0x3
#define DSS_5_BIT_TRANSFER	0x4
#define DSS_6_BIT_TRANSFER	0x5
#define DSS_7_BIT_TRANSFER	0x6
#define DSS_8_BIT_TRANSFER	0x7
#define DSS_9_BIT_TRANSFER	0x8
#define DSS_10_BIT_TRANSFER	0x9
#define DSS_11_BIT_TRANSFER	0xA
#define DSS_12_BIT_TRANSFER	0xB
#define DSS_13_BIT_TRANSFER	0xC
#define DSS_14_BIT_TRANSFER	0xD
#define DSS_15_BIT_TRANSFER	0xE
#define DSS_16_BIT_TRANSFER	0xF

#define CPOL_KEEP_LOW		(0<<6)	//Mantiene el clock en BAJO cuando no manda bytes
#define CPOL_KEEP_HIGH		(1<<6)	//Mantiene el clock en ALTO cuando no manda bytes

#define CPHA_RISING_EDGE	(0<<7)	//Captura los datos en flanco ascendente  (1er flanco de clock)
#define CPHA_FALLING_EDGE	(1<<7)	//Captura los datos en flanco descendente (2do flanco de clock)
