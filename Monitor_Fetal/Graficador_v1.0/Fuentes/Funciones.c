...
//						PRUEBASSSSSSSSSSSSSSSSSSSSSSSS
//__________________________________________________________________________________________________________________________________________________________________________
...
int i_ind_buff;
int lat_adc,lat_ant,LAT_PROM;
char ind_adc=0,SUBIR,BAJAR,desp_vert,SALTO;
extern int valpru[];
...
//8 puntos por linea en 4 lineas
void Graf_latidos(void)
{
	char *		renglon = buffer_pulso ;
	char n;
	if(PROMEDIAR)
...
void func_temp(void)
{
	...
	if( (0x000 < lat_adc) && (lat_adc < 0x100) )
	{
		pos_y=2;
		hab_corazon=1;
		num_pulso=140;
	...
	if( (0x100 < lat_adc) && (lat_adc < 0x500) )
	{
		pos_y=3;
		hab_corazon=1;
		num_pulso=130;
	...
	if(	(0x500 < lat_adc) && (lat_adc < 0xA00) )
	{
		pos_y=4;
		hab_corazon=1;
		num_pulso=120;
	...
	if( (0xA00 < lat_adc) && (lat_adc < 0xC00) )
	{
		pos_y=5;
		hab_corazon=1;
		num_pulso=110;
	...
	if(	(0xC00 < lat_adc) && (lat_adc < 0xFFF) )
	{
		pos_y=6;
		hab_corazon=1;
		num_pulso=100;
