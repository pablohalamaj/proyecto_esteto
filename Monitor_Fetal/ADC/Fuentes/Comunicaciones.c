...
extern char 			Rx[],Rx1[],Rx2[],btens[],movmp[],version[],version_prt[],modo_func,
						causaerr[],moduloerr[],icomu[],sumaerr,lec,ledcoo,prs,velc,dir_comu,
						cont,flagmm,flagbll,menuactual,actualiza_fw;
