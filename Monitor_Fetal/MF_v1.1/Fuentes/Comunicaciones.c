 ...
 *	Comentarios:
 *
 * Recibe y envia datos por SPI (Display/SD Card)
****************************************************************************/
...
extern char 			Rx[],Rx1[],Rx2[],btens[],toffset[],movmp[],version[],
						version_prt[],modo_func,causaerr[],moduloerr[],icomu[],
						b_tog[],sumaerr,lec,ledcoo,prs,velc,dir_comu,
